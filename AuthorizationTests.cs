...
namespace Neo.Tests
{
    ...
    {
        private readonly Dictionary<string, Permission> adminPermissions = new Dictionary<string, Permission> {
            { "neo.*", Permission.Allow }
        };

        private readonly Dictionary<string, Permission> guestPermissions = new Dictionary<string, Permission> {
            { "neo.channel.join.$", Permission.Allow },
            { "neo.global.*", Permission.Allow }
        };

        private readonly Dictionary<string, Permission> userPermissions = new Dictionary<string, Permission> {
